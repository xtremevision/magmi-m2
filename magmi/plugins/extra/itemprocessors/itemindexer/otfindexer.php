...
class ItemIndexer extends Magmi_ItemProcessor
{
    ...
    public function builProductUrlRewrite($pid, $dorewrite = false, $store='admin')
    {
        ...
        // insert lines
        $sqlprod = "INSERT INTO {$this->tns["curw"]} (entity_type,entity_id,store_id,target_path,request_path,redirect_type,is_autogenerated) $produrlsql ON DUPLICATE KEY UPDATE request_path=VALUES(`request_path`)";
